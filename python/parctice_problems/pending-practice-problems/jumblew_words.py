...
Try to solve these new programming puzzles. If you like my work, make sure to check out my courses. This exercise is a part of python tutorial for absolute begineers. To learn more about python, stay up to date with codewithharry."""